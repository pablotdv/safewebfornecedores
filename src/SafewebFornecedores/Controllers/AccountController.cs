...
using SafewebFornecedores.Results;
...
namespace SafewebFornecedores.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            var result = await UserManager.ChangePasswordAsync(Guid.Parse(User.Identity.GetUserId()), model.OldPassword,
                model.NewPassword);
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new Usuario() { UserName = model.Email, Email = model.Email, Cpf = model.Cpf, DataNascimento = model.DataNascimento, Nome = model.Nome };
            try
            {
